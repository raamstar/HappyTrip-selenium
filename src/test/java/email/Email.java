...
public class Email {
	...
	public static void sendEmail() throws EmailException, MalformedURLException
	{
		  ...
		  email.setAuthenticator(new DefaultAuthenticator("raamstar005@gmail.com", "newpassword75"));
		  email.setSSLOnConnect(true);
		  
		  email.addTo("raamstar005@gmail.com");
		  email.setFrom("raamstar005@gmail.com");
